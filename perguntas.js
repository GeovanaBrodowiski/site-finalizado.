export const perguntas = [
    {
        enunciado: "Quais são as cores do Anel Olímpico?",
        alternativas: [
            {
                texto: "Azul, preto, vermelho, amarelo e verde.",
                afirmacao: [
            ...
            {
                texto: "Azul, preto, vermelho, amarelo e rosa.",
                afirmacao: [
    ...
    {
        enunciado: "Qual o significado da Tocha Olímpica?",
        alternativas: [
            {
                texto: "A paz e a amizade entre as nações.",
                afirmacao: [
    ...
    {
        enunciado: "Qual é o nome do mascote do ano de 2024?",
        alternativas: [
            {
                texto: "Phyrge.",
                afirmacao: [
    ...
    {
        enunciado: "Qual é o significado dos troféus e das medalhas?",
        alternativas: [
            {
                texto: "Vitória.",
                afirmacao: [
